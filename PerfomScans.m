...
for i = 1:length(newClouds)
    ...
    disp('Registration parameters: (x, y, z, omega, phi, kappa)');
    disp(newClouds(i).scan.regParams(1:3)');
    disp(newClouds(i).scan.regParams(4:6)');
    disp('Registration parameter standard deviations: (mm, arcseconds)')
...
disp('Mean Standard Deviation of X, Y, Z post registration (mm):')
